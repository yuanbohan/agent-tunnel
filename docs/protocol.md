...
| `GET /api/updates/ws` | Client | Basic Auth | WebSocket | Global live output updates and structured client input |
...
- `seq`: strictly increasing output sequence number within the live session
